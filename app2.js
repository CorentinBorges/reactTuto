...
class Home3 extends React.Component{
    ...
    render(){
        return <form className="container"  onSubmit={this.handleSubmit}>
                <Column2
                    left={<Field name="nom" value={this.state.nom} onChange={this.handleChange} >Nom</Field>}
                    right={<Field name="prenom" value={this.state.prenom} onChange={this.handleChange} >Prénom</Field>}
                />
                
                <Checkbox name="newsletter" value={this.state.newsletter} onChange={this.handleChange} >S'abonner à la newletter </Checkbox>
